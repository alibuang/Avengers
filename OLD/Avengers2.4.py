...
while True:    
    try:
        ...
        while curr_time != prev_time and minute > 3 :
            ...
            d1_candle_status = check_candle(Symbols, timeframe.Daily, 1)  
            h1_candle_status = check_candle(Symbols, timeframe.H1, 1)  
            print('H1 status:', h1_candle_status, '\nDaily CS status:', d1_candle_status)
