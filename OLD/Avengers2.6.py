...
while True:    
    try:
        ...
        #publish status every 15 minutes
        if datetime.now().minute % 15 == 1 or first_run:
            ...
            if higher_candle_status and lower_candle_status:
                ...
                higher_dt = cal_tz.localize(higher_dt).astimezone(local_tz)
                lower_dt = cal_tz.localize(lower_dt).astimezone(local_tz)
