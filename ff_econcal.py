...
def getEconomicCalendar(startlink,endlink):
    ...
    df_cols = ["datetime","currency","impact","event","actual","forecast","previous"]
...
#            print(",".join([str(dt),currency,impact,event,actual,forecast,previous]))
            ...
            data = [str(dt),currency,impact,event,actual,forecast,previous]
            df.loc[i] = data
            i += 1
...
if __name__ == "__main__":
    ...
    """
    setLogger()
    getEconomicCalendar("calendar.php?week=jan7.2007","calendar.php?week=jun24.2018")